...
class MyStatefulpentatrape2 extends StatefulWidget {
  const MyStatefulpentatrape2({Key? key}) : super(key: key);

  @override
  State<MyStatefulpentatrape2> createState() => _MyStatefulpentatrapeState2();
}

class _MyStatefulpentatrapeState2 extends State<MyStatefulpentatrape2> {
...
class Mypentatrape2 extends StatefulWidget {
  // ignore: use_key_in_widget_constructors
  const Mypentatrape2();

  @override
  _MypentatrapeState2 createState() => _MypentatrapeState2();
}

class _MypentatrapeState2 extends State<Mypentatrape2> {
  var imageArray = [
    'one.png',
    'two.png',
    'three.png',

...
class MyStatefulCube extends StatefulWidget {
  const MyStatefulCube({Key? key}) : super(key: key);

  @override
  State<MyStatefulCube> createState() => MyStatefulCubeState();
}

class MyStatefulCubeState extends State<MyStatefulCube> {
  ...
  Widget build(BuildContext context) {
    return Slider(
      ...
      max: 4,
      divisions: 3,
      activeColor: const Color.fromARGB(255, 61, 61, 61),
...
class MyCube extends StatefulWidget {
  ...
  @override
  _MyCubeState createState() => _MyCubeState();
}

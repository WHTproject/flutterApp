...
class MyStatefulCube4 extends StatefulWidget {
  const MyStatefulCube4({Key? key}) : super(key: key);

  @override
  State<MyStatefulCube4> createState() => MyStatefulCubeState4();
}

class MyStatefulCubeState4 extends State<MyStatefulCube4> {
...
class MyCube4 extends StatefulWidget {
  // ignore: use_key_in_widget_constructors
  const MyCube4();

  @override
  _MyCubeState4 createState() => _MyCubeState4();
}

class _MyCubeState4 extends State<MyCube4> {
  var imageArray = [
    'one.png',
    'two.png',
    'three.png',
  ...
  int randomIntForDiceFour = Random().nextInt(6);
            ...
            children: <Widget>[
              ...
              Row(
                ...
                children: <Widget>[
                  ...
                  Image.asset(
                    'cube/' + imageArray[randomIntForDiceFour],
                    height: 75,
                    width: 75,
                  ),
                ],
  ...
  void changeImage() {
    setState(() {
      ...
      randomIntForDiceFour = Random().nextInt(6);
    });
  }
}
